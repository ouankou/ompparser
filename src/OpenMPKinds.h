...
#define OPENMP_IF_MODIFIER(Name) OMPC_IF_MODIFIER_##Name,
  ...
  OPENMP_IF_MODIFIER(teams)
  OPENMP_IF_MODIFIER(task_iteration)
  OPENMP_IF_MODIFIER(taskgraph)
...
#define OPENMP_DEPENDENCE_TYPE(Name) OMPC_DEPENDENCE_TYPE_##Name,
  ...
  OPENMP_DEPENDENCE_TYPE(inoutset)
...
#define OPENMP_TO_KIND(Name) OMPC_TO_##Name,
  ...
  OPENMP_TO_KIND(iterator)
  OPENMP_TO_KIND(present)
...
#define OPENMP_FROM_KIND(Name) OMPC_FROM_##Name,
  ...
  OPENMP_FROM_KIND(iterator)
  OPENMP_FROM_KIND(present)
...
#define OPENMP_MAP_MODIFIER(Name) OMPC_MAP_MODIFIER_##Name,
  ...
  OPENMP_MAP_MODIFIER(present)
  OPENMP_MAP_MODIFIER(self)
  OPENMP_MAP_MODIFIER(mapper)
  OPENMP_MAP_MODIFIER(iterator)
...
#define OPENMP_MAP_REF_MODIFIER(Name) OMPC_MAP_REF_MODIFIER_##Name,
  OPENMP_MAP_REF_MODIFIER(ref_ptee)
  OPENMP_MAP_REF_MODIFIER(ref_ptr)
  OPENMP_MAP_REF_MODIFIER(ref_ptr_ptee)
  OPENMP_MAP_REF_MODIFIER(unspecified)
